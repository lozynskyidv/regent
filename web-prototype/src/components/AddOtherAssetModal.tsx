...
interface AddOtherAssetModalProps {
  isOpen: boolean;
  onClose: () => void;
  onAdd: (asset: { name: string; value: number }) => void;
  onUpdate?: (asset: { name: string; value: number }) => void;
  initialData?: { name: string; value: number } | null;
}

export function AddOtherAssetModal({ isOpen, onClose, onAdd, onUpdate, initialData }: AddOtherAssetModalProps) {
