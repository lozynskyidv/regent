...
export function ConnectCreditCardModal({ isOpen, onClose, onConnect }: ConnectCreditCardModalProps) {
  if (!isOpen) return null;

  const handleConnect = () => {
    // In production, this would initiate TrueLayer OAuth flow
    console.log('Initiating TrueLayer credit card connection...');
    onConnect();
  };
      ...
      >
        ...
        >
          ...
          <div className="text-center space-y-2">
            ...
            >
              Connect your credit cards via TrueLayer to automatically track outstanding balances and keep your net worth accurate.
            </p>
          </div>
          ...
          >
            ...
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                >
                  Outstanding balances sync automatically, reflecting credit utilization in your net worth without manual updates.
                </p>
              </div>
            </div>
          </div>
          ...
          <div>
            ...
            >
              Supports all major UK credit cards
            </p>
            <div 
