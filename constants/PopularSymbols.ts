...
// Top 20 Commodities
// NOTE: Precious metals use forex pair format (XAU/USD, XAG/USD, etc.)
// This matches Twelve Data API requirements for commodity pricing
export const POPULAR_COMMODITIES: Symbol[] = [
  { ticker: 'XAU/USD', name: 'Gold' },
  { ticker: 'XAG/USD', name: 'Silver' },
  { ticker: 'XPT/USD', name: 'Platinum' },
  { ticker: 'XPD/USD', name: 'Palladium' },
  { ticker: 'HG/USD', name: 'Copper' },
  { ticker: 'WTI/USD', name: 'Crude Oil (WTI)' },
  { ticker: 'BRENT/USD', name: 'Crude Oil (Brent)' },
  { ticker: 'NG/USD', name: 'Natural Gas' },
  { ticker: 'ZW/USD', name: 'Wheat' },
  { ticker: 'ZC/USD', name: 'Corn' },
  { ticker: 'ZS/USD', name: 'Soybeans' },
  { ticker: 'SB/USD', name: 'Sugar' },
  { ticker: 'KC/USD', name: 'Coffee' },
  { ticker: 'CT/USD', name: 'Cotton' },
  { ticker: 'CC/USD', name: 'Cocoa' },
  { ticker: 'ALI/USD', name: 'Aluminum' },
  { ticker: 'ZNC/USD', name: 'Zinc' },
  { ticker: 'NI/USD', name: 'Nickel' },
  { ticker: 'LBS/USD', name: 'Lumber' },
  { ticker: 'UX/USD', name: 'Uranium' },
];
