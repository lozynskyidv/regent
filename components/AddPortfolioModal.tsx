/**
 * Add Portfolio Modal
 * Multi-holding portfolio with live price fetching
...
export default function AddPortfolioModal({ visible, onClose }: AddPortfolioModalProps) {
  ...
  const handleSubmit = async () => {
    ...
    if (validHoldings.length === 0) {
      Alert.alert('Error', 'Please add at least one valid holding with a ticker and quantity');
      return;
    }
          ...
          >
            ...
            <View style={styles.field}>
              ...
              <TextInput
                ...
                placeholder="e.g., My Tech Stocks, Crypto Holdings"
            ...
            <View style={styles.infoBox}>
              <Text style={styles.infoTitle}>Supported Assets</Text>
              <Text style={styles.infoText}>
                Stocks (AAPL, TSLA), ETFs (VOO, SPY), Crypto (BTC/USD, ETH/USD), Commodities (GOLD, SILVER). Prices update automatically every 5-15 minutes.
              </Text>
            </View>
