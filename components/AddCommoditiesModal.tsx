 ...
 * Track commodity holdings with live price fetching
 * Supports: GOLD, SILVER, OIL, COPPER, etc.
 */
...
export default function AddCommoditiesModal({ visible, onClose }: AddCommoditiesModalProps) {
  ...
  const handleSubmit = async () => {
    ...
    if (!portfolioName.trim()) {
      Alert.alert('Error', 'Please enter a name for your commodities');
      return;
    }
    ...
    try {
      ...
      Alert.alert('Error', 'Failed to add commodities. Please try again.');
      console.error('Add commodities error:', error);
    } finally {
      ...
      <SafeAreaView style={styles.container} edges={['top']}>
        ...
        >
          ...
          <View style={styles.header}>
            ...
            <Text style={styles.title}>Add Commodities</Text>
          ...
          >
            ...
            <View style={styles.field}>
              ...
              <TextInput
                ...
                placeholder="e.g., Precious Metals, Raw Materials"
            ...
            <View style={styles.infoBox}>
              <Text style={styles.infoTitle}>Supported Commodities</Text>
              <Text style={styles.infoText}>
                Commodities: GOLD, SILVER, OIL, COPPER, PLATINUM, etc. Prices update via pull-to-refresh on home screen.
              </Text>
            </View>
            ...
            >
              <Text style={styles.submitButtonText}>
                {isSubmitting ? 'Adding Commodities...' : 'Add Commodities'}
              </Text>
            </TouchableOpacity>
          </ScrollView>
        </KeyboardAvoidingView>
