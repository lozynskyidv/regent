/**
 * Add Crypto Modal
 * Track cryptocurrency holdings with live price fetching
 * Supports: BTC, ETH, SOL, ADA, etc. (auto-formats to BTC/USD, ETH/USD)
 */
...
export default function AddCryptoModal({ visible, onClose }: AddCryptoModalProps) {
  ...
  const handleSubmit = async () => {
    ...
    if (!portfolioName.trim()) {
      Alert.alert('Error', 'Please enter a name for your crypto holdings');
      return;
    }
    ...
    if (validHoldings.length === 0) {
      Alert.alert('Error', 'Please add at least one valid cryptocurrency with a symbol and amount');
      return;
    }
    ...
    try {
      ...
      Alert.alert('Error', 'Failed to add crypto. Please try again.');
          ...
          >
            ...
            <View style={styles.field}>
              ...
              <TextInput
                ...
                placeholder="e.g., Bitcoin Holdings, Crypto Portfolio"
            ...
            <View style={styles.section}>
              ...
              <TouchableOpacity style={styles.addHoldingButton} onPress={addHolding} activeOpacity={0.7}>
                ...
                <Text style={styles.addHoldingText}>Add Crypto</Text>
              </TouchableOpacity>
            </View>
            ...
            <View style={styles.infoBox}>
              <Text style={styles.infoTitle}>Supported Cryptocurrencies</Text>
              <Text style={styles.infoText}>
                Just type the symbol: BTC, ETH, SOL, ADA, DOT, MATIC, etc. Auto-formats to BTC/USD pair. Prices update via pull-to-refresh on home screen.
              </Text>
            </View>
            ...
            >
              <Text style={styles.submitButtonText}>
                {isSubmitting ? 'Adding Crypto...' : 'Add Crypto'}
              </Text>
            </TouchableOpacity>
          </ScrollView>
        </KeyboardAvoidingView>
