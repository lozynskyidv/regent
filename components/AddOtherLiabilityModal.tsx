/**
 * Add Other Liability Modal
 * Simple modal for adding miscellaneous liabilities
...
export default function AddOtherLiabilityModal({ visible, onClose }: AddOtherLiabilityModalProps) {
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      Alert.alert('Error', 'Failed to add liability. Please try again.');
      console.error('Add other liability error:', error);
    } finally {
          ...
          >
            ...
            <View style={styles.field}>
              ...
              <TextInput
                ...
                placeholder="e.g., Personal Debt, IOU"
