/**
 * Add ETFs Modal
 * Track ETF holdings with live price fetching
 * Supports: SPY, QQQ, VOO, VTI, IVV, etc.
 */
...
export default function AddETFsModal({ visible, onClose }: AddETFsModalProps) {
  ...
  const handleSubmit = async () => {
    ...
    if (!portfolioName.trim()) {
      Alert.alert('Error', 'Please enter a name for your ETFs');
      return;
    }
    ...
    try {
      ...
      Alert.alert('Error', 'Failed to add ETFs. Please try again.');
      console.error('Add ETFs error:', error);
    } finally {
      ...
      <SafeAreaView style={styles.container} edges={['top']}>
        ...
        >
          ...
          <View style={styles.header}>
            ...
            <Text style={styles.title}>Add ETFs</Text>
          ...
          >
            ...
            <View style={styles.field}>
              ...
              <TextInput
                ...
                placeholder="e.g., Index Funds, Passive ETFs"
            ...
            <View style={styles.infoBox}>
              <Text style={styles.infoTitle}>Supported ETFs</Text>
              <Text style={styles.infoText}>
                US ETFs: SPY, QQQ, VOO, VTI, IVV, SCHD, etc. Prices update via pull-to-refresh on home screen.
              </Text>
            </View>
            ...
            >
              <Text style={styles.submitButtonText}>
                {isSubmitting ? 'Adding ETFs...' : 'Add ETFs'}
              </Text>
            </TouchableOpacity>
          </ScrollView>
        </KeyboardAvoidingView>
