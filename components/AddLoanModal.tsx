/**
 * Add Loan Modal
 * Loan entry with type dropdown (Personal, Car, Student)
...
type LoanType = 'Personal' | 'Car' | 'Student';

export default function AddLoanModal({ visible, onClose }: AddLoanModalProps) {
  ...
  const loanTypes: LoanType[] = ['Personal', 'Car', 'Student'];
  ...
  const canSubmit = loanType && lender.trim() && outstandingBalance && !isSubmitting;
          ...
          >
            ...
            <View style={styles.field}>
              ...
              <TouchableOpacity
                ...
                activeOpacity={0.7}
              >
                <Text style={[styles.dropdownText, !loanType && styles.dropdownPlaceholder]}>
                  {loanType || 'Select type'}
                </Text>
